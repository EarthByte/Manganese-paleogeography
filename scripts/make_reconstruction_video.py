...
occurrences are small black dots (all reliable-age sedimentary + metamorphic classes A/B/C, shown as spatial context — broader than the principled A+B + gondite set used in the figures/test). Plate IDs are
